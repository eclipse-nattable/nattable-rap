...
import org.eclipse.nebula.widgets.nattable.examples._600_GlazedLists._603_Filter._6032_GlazedListsFilterCustomTypesExample.MyRowObject.Gender;
 ...
 */
public class _6032_GlazedListsFilterCustomTypesExample extends AbstractNatExample {
    ...
    public String getDescription() {
        return "This example shows the usage of the filter row within a grid"
                ...
                + " shows how to add support for filtering custom data types.";
    }
    ...
    class FilterRowConfiguration extends AbstractRegistryConfiguration {
        ...
        public void configureRegistry(IConfigRegistry configRegistry) {
            ...
            // register a combo box cell editor for the city column in the
            // filter row
            // the label is set automatically to the value of
            // FilterRowDataLayer.FILTER_ROW_COLUMN_LABEL_PREFIX + column
            // position
