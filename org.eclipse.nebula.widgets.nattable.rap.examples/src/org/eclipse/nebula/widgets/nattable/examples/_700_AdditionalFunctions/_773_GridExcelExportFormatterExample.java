...
public class _773_GridExcelExportFormatterExample extends AbstractNatExample {
    ...
    private ILayerExporter currentExporter = null;
    ...
    public Control createExampleControl(Composite parent) {
        ...
        exportCsvButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                _773_GridExcelExportFormatterExample.this.currentExporter = new CsvExporter();
                natTable.doCommand(
                        new ExportCommand(
                                ...
                                false,
                                false,
                                _773_GridExcelExportFormatterExample.this.currentExporter,
                                false,
                                () -> {
        ...
        exportXlsButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                // ConfigRegistry
                _773_GridExcelExportFormatterExample.this.currentExporter = natTable.getConfigRegistry().getConfigAttribute(
                        ExportConfigAttributes.EXPORTER,
                        DisplayMode.NORMAL);
                natTable.doCommand(
                        new ExportCommand(
        ...
        exportXlsxButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                exporter.setApplyVerticalTextConfiguration(true);
                exporter.setApplyBackgroundColor(false);
                _773_GridExcelExportFormatterExample.this.currentExporter = exporter;
                natTable.doCommand(
                        new ExportCommand(
                                natTable.getConfigRegistry(),
                                natTable.getShell(),
        ...
        downloadButton.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                if (_773_GridExcelExportFormatterExample.this.currentExporter != null) {
                    if (_773_GridExcelExportFormatterExample.this.currentExporter.getResult() instanceof File) {
                        File file = (File) _773_GridExcelExportFormatterExample.this.currentExporter.getResult();
