 ...
 * While the values for the first three columns are returned directly, the
 * values for column four and five are calculated.
 */
...
/**
 * The body layer stack for the {@link CalculatingGridExample}. Consists of
 * <ol>
 * <li>ViewportLayer</li>
...
class CalculatingEditConfiguration extends AbstractRegistryConfiguration {
    ...
    public void configureRegistry(IConfigRegistry configRegistry) {
        ...
        configRegistry.registerConfigAttribute(
                ...
                DisplayMode.EDIT,
                CalculatingGridExample.COLUMN_FOUR_LABEL);
        configRegistry.registerConfigAttribute(
                EditConfigAttributes.CELL_EDITABLE_RULE,
                IEditableRule.NEVER_EDITABLE,
                DisplayMode.EDIT,
