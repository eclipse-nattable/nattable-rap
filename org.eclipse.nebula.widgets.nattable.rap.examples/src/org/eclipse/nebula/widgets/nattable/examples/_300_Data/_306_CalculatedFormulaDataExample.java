...
public class _306_CalculatedFormulaDataExample extends AbstractNatExample {
    ...
    public Control createExampleControl(Composite parent) {
        ...
        addRowButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                _306_CalculatedFormulaDataExample.this.valuesToShow.add(createNumberValues());
                natTable.refresh();
            }
        });
     ...
     */
    class CalculatingDataProvider extends ListDataProvider<NumberValues> {
    ...
    /**
     * The body layer stack for the {@link _306_CalculatedFormulaDataExample}.
     * Consists of
     * <ol>
     * <li>ViewportLayer</li>
    ...
    class CalculatingBodyLayerStack extends AbstractLayerTransform {
        ...
        public CalculatingBodyLayerStack(EventList<NumberValues> valuesToShow, ConfigRegistry configRegistry) {
            ...
            FormulaDataProvider fda = new FormulaDataProvider(dataProvider);
            this.bodyDataLayer = new DataLayer(fda);
     ...
     * {@link _306_CalculatedFormulaDataExample}.
     */
    ...
    class CalculatingEditConfiguration extends AbstractRegistryConfiguration {
        ...
        public void configureRegistry(IConfigRegistry configRegistry) {
            ...
            configRegistry.registerConfigAttribute(
                    ...
                    _306_CalculatedFormulaDataExample.COLUMN_FOUR_LABEL);
            configRegistry.registerConfigAttribute(
                    EditConfigAttributes.CELL_EDITABLE_RULE,
                    IEditableRule.NEVER_EDITABLE, DisplayMode.EDIT,
                    _306_CalculatedFormulaDataExample.COLUMN_FIVE_LABEL);
