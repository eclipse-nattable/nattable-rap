...
public class _814_EditableSortableGroupByWithFilterExample extends AbstractNatExample {
    ...
    public Control createExampleControl(Composite parent) {
        ...
        Button addDynamicDataButton1 = new Button(buttonPanel, SWT.PUSH);
        addDynamicDataButton1.setText("Do some update");
        addDynamicDataButton1.addSelectionListener(new SelectionAdapter() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                Person first = bodyLayerStack.getEventList().get(0);
                first.setLastName("Burns");
                bodyLayerStack.getBodyDataLayer().fireLayerEvent(new RowVisualUpdateEvent(bodyLayerStack.getBodyDataLayer(), 0));
            }
        });
            ...
            this.bodyDataLayer.registerCommandHandler(new UpdateDataCommandHandler(this.bodyDataLayer) {
                ...
                protected boolean doCommand(UpdateDataCommand command) {
                    if (super.doCommand(command)) {
                        T o = BodyLayerStack.this.bodyDataProvider.getRowObject(command.getRowPosition());
