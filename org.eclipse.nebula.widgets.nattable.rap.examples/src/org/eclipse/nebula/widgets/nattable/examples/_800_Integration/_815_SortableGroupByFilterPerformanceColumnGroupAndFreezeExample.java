/*******************************************************************************
 * Copyright (c) 2019, 2025 Dirk Fauth and others.
 *
 ...
 * Additionally adds sorting, filtering, freeze and the new performance column
 * grouping support.
 */
public class _815_SortableGroupByFilterPerformanceColumnGroupAndFreezeExample extends AbstractNatExample {
    ...
    public String getDescription() {
        return "This example shows the usage of the group by feature in conjunction with summary values of the groupings, "
                + "sorting, filtering, freeze and the new performance column grouping support.";
    }
    ...
    public Control createExampleControl(Composite parent) {
        ...
        // columnGroupHeaderLayer.setGroupUnbreakable(0, true);
        ...
        natTable.addConfiguration(new AbstractRegistryConfiguration() {
            ...
            public void configureRegistry(IConfigRegistry configRegistry) {
                configRegistry.registerConfigAttribute(
                        ...
                        _815_SortableGroupByFilterPerformanceColumnGroupAndFreezeExample.this.sumMoneySummaryProvider,
                        DisplayMode.NORMAL,
        ...
        natTable.addConfiguration(new AbstractHeaderMenuConfiguration(natTable) {
            ...
            protected PopupMenuBuilder createColumnHeaderMenu(NatTable natTable) {
                return super.createColumnHeaderMenu(natTable)
                        ...
                        // notice that we use the menu item for the performance
                        // column grouping
        ...
        toggleMoneySummaryButton.addSelectionListener(new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                _815_SortableGroupByFilterPerformanceColumnGroupAndFreezeExample.this.useMoneySum =
                        !_815_SortableGroupByFilterPerformanceColumnGroupAndFreezeExample.this.useMoneySum;
                if (_815_SortableGroupByFilterPerformanceColumnGroupAndFreezeExample.this.useMoneySum) {
                    configRegistry.registerConfigAttribute(
                            GroupByConfigAttributes.GROUP_BY_SUMMARY_PROVIDER,
                            _815_SortableGroupByFilterPerformanceColumnGroupAndFreezeExample.this.sumMoneySummaryProvider,
                            DisplayMode.NORMAL,
                    ...
                    configRegistry.registerConfigAttribute(
                            GroupByConfigAttributes.GROUP_BY_SUMMARY_PROVIDER,
                            _815_SortableGroupByFilterPerformanceColumnGroupAndFreezeExample.this.avgMoneySummaryProvider,
                            DisplayMode.NORMAL,
                            GroupByDataLayer.GROUP_BY_COLUMN_PREFIX + 3);
                }
