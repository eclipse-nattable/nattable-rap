    ...
    public Control createExampleControl(Composite parent) {
        ...
        natTable.addConfiguration(
                new DefaultFormulaConfiguration(
                        ...
                        bodyLayer.getCompositeFreezeLayerPainter()));
        // FIXME tooltips are not supported with RAP
        // bodyLayer.getFormulaDataProvider().setErrorReporter(new
        // FormulaTooltipErrorReporter(natTable, bodyLayer.getDataLayer()));
